...
contract NFTRoyalties is ERC721, ERC2981, Ownable{
    ...
    //uint96 public txtrnsfee;
    //uint256 public tokenId;

    mapping(uint256=>address) owners;

    constructor()ERC721("NFTRoyalties","Aksh"){
        setRoyaltyInfo(msg.sender,25);
    }
    ...
    function mint(uint256 tokenId) public payable{
        ...
        require((chargeFees*tokenId)/1e18<msg.value,"not enough gas in the account");
    ...
    function setRoyaltyInfo(address receiver, uint96 feeNum) public onlyOwner{
